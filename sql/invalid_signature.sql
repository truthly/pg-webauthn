...
SELECT * FROM webauthn.verify_assertion(
  ...
  signature := 'this_is_a_valid_base64url_value_of_expected_length_but_not_a_valid_signature___________________',
 ...
 * ERROR:  new row for relation "assertions" violates check constraint "verify_signature"
