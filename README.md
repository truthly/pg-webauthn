...
See [sql/valid_signature.sql](https://github.com/truthly/pg-webauthn/blob/master/sql/valid_signature.sql)
for a complete example possible to execute manually in the psql prompt, step by step.
