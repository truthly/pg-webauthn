...
<h3 id="init-credential"><code>webauthn.init_credential(challenge bytea, relying_party_name text, relying_party_id text, user_name text, user_id bytea, user_display_name text, timeout interval) RETURNS jsonb</code></h3>
...
```sql
SELECT webauthn.init_credential(username := 'test', relying_party := 'localhost');
```
...
<h3 id="make-credential"><code>webauthn.make_credential(username text, challenge base64, credential_raw_id base64, credential_type text, attestation_object base64, client_data_json base64, relying_party text) RETURNS bigint</code></h3>
...
<h3 id="get-credentials"><code>webauthn.get_credentials(username text, relying_party text) RETURNS jsonb</code></h3>
...
<h3 id="verify-assertion"><code>webauthn.verify_assertion(credential_raw_id base64, credential_type text, authenticator_data base64, client_data_json base64, signature base64, user_handle base64, relying_party text) RETURNS bigint</code></h3>
